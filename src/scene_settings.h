...
enum { ORBITAL_SETTING_MOTION, ORBITAL_SETTING_RADIUS, ORBITAL_SETTING_DEPTH,
       ...
       ORBITAL_SETTING_HUE, ORBITAL_SETTING_REACTIVITY, ORBITAL_SETTING_SWAY };
...
enum { ATLAS_SETTING_HEIGHT, ATLAS_SETTING_WIDTH, ATLAS_SETTING_DEPTH,
       ...
       ATLAS_SETTING_ORBIT, ATLAS_SETTING_ZOOM };
...
enum { LOOM_SETTING_DENSITY, LOOM_SETTING_WEIGHT, LOOM_SETTING_COMPLEXITY,
       ...
       LOOM_SETTING_GLINTS };
enum { PENTAGRAM_SETTING_MOTION, PENTAGRAM_SETTING_NEST,
       PENTAGRAM_SETTING_ORBITS, PENTAGRAM_SETTING_GLOW,
       PENTAGRAM_SETTING_CHORDS, PENTAGRAM_SETTING_HUE,
       PENTAGRAM_SETTING_PULSE, PENTAGRAM_SETTING_ZOOM };
